...
PDF_INGEST_FOLDER = os.environ.get("PDF_INGEST_FOLDER", str(_REPO_ROOT /  "sample-data"))
...
def _generate_embeddings(texts: list[str], credential: DefaultAzureCredential) -> list[list[float]] | None:
    ...
    if not foundry_endpoint:
        logger.warning("AZURE_AI_PROJECT_ENDPOINT not set — skipping embedding generation")
        return None
